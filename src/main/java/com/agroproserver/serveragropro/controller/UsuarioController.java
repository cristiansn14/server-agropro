...
public class UsuarioController {
    ...
    @GetMapping("/findAllUsuariosAlta")
    public ResponseEntity<?> findAllUsuariosAlta() {
        return usuarioService.findAllUsuariosAlta();
    }

    @GetMapping("/findAllUsuariosBaja")
    public ResponseEntity<?> findAllUsuariosBaja() {
        return usuarioService.findAllUsuariosBaja();
    }

    @PutMapping("/darAltaUsuario")
    public ResponseEntity<?> darAltaUsuario(@RequestBody UUID idUsuario) {
        return usuarioService.darAltaUsuario(idUsuario);
    }

    @DeleteMapping("/darBajaUsuario/{idUsuario}")
    public ResponseEntity<?> darBajaUsuario(@PathVariable UUID idUsuario){
        return usuarioService.darBajaUsuario(idUsuario);
    }
}
